...
(
   ...
   FECHA_LIMITE_EXCURSION TIMESTAMP,
   FECHA_SALIDA_EXCURSION TIMESTAMP,
   FECHA_RETORNO_EXCURSION TIMESTAMP,
   MIN_ASISTENTES_EXCURSION INTEGER,
   MAX_ASISTENTES_EXCURSION INTEGER,
